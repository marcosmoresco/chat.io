    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid37", tween: [ "style", "${_Rectangle2}", "left", '221px', { fromValue: '28px'}], position: 0, duration: 2000 },
                { id: "eid38", tween: [ "style", "${_Rectangle2}", "left", '27px', { fromValue: '221px'}], position: 2000, duration: 2000 },
                { id: "eid39", tween: [ "style", "${_Rectangle2}", "width", '106px', { fromValue: '494px'}], position: 0, duration: 2000 },
                { id: "eid40", tween: [ "style", "${_Rectangle2}", "width", '495px', { fromValue: '106px'}], position: 2000, duration: 2000 },
